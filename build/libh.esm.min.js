...
`;case 114:return"\r";case 120:return String.fromCharCode(this.readHexChar(2));case 117:return B(this.readCodePoint());case 116:return"	";case 98:return"\b";case 118:return"\v";case 102:return"\f";case 13:this.input.charCodeAt(this.pos)===10&&++this.pos;case 10:return this.options.locations&&(this.lineStart=this.pos,++this.curLine),"";case 56:case 57:if(this.strict&&this.invalidStringToken(this.pos-1,"Invalid escape sequence"),e){var i=this.pos-1;this.invalidStringToken(i,"Invalid escape sequence in template string")}default:if(t>=48&&t<=55){var s=this.input.substr(this.pos-1,3).match(/^[0-7]+/)[0],r=parseInt(s,8);return r>255&&(s=s.slice(0,-1),r=parseInt(s,8)),this.pos+=s.length-1,t=this.input.charCodeAt(this.pos),(s!=="0"||t===56||t===57)&&(this.strict||e)&&this.invalidStringToken(this.pos-1-s.length,e?"Octal literal in template string":"Octal literal in strict mode"),String.fromCharCode(r)}return G(t)?"":String.fromCharCode(t)}};x.readHexChar=function(e){var t=this.pos,i=this.readInt(16,e);return i===null&&this.invalidStringToken(t,"Bad character escape sequence"),i};x.readWord1=function(){this.containsEsc=!1;for(var e="",t=!0,i=this.pos,s=this.options.ecmaVersion>=6;this.pos<this.input.length;){var r=this.fullCharCodeAtPos();if(j(r,s))this.pos+=r<=65535?1:2;else if(r===92){this.containsEsc=!0,e+=this.input.slice(i,this.pos);var n=this.pos;this.input.charCodeAt(++this.pos)!==117&&this.invalidStringToken(this.pos,"Expecting Unicode escape sequence \\uXXXX"),++this.pos;var u=this.readCodePoint();(t?T:j)(u,s)||this.invalidStringToken(n,"Invalid Unicode escape"),e+=B(u),i=this.pos}else break;t=!1}return e+this.input.slice(i,this.pos)};x.readWord=function(){var e=this.readWord1(),t=a.name;return this.keywords.test(e)&&(t=de[e]),this.finishToken(t,e)};var Wt="8.10.0";y.acorn={Parser:y,version:Wt,defaultOptions:pe,Position:K,SourceLocation:ae,getLineInfo:Ve,Node:ne,TokenType:v,tokTypes:a,keywordTypes:de,TokContext:P,tokContexts:g,isIdentifierChar:j,isIdentifierStart:T,Token:ke,isNewLine:G,lineBreak:A,lineBreakG:vt,nonASCIIwhitespace:Pe};function ot(e,t){return y.parse(e,t)}var ht={registry:Object.create(null),HTMLParser:new DOMParser};function zt(e,t){let i={},s=""+t,r=ot(s),n={argument:r.body[0].expression.params[0].name,connectedAccess:r.body[0].expression.body};return console.log(r.body[0].expression),{TEMPLATE_STRING:s}}function Qt(e,t,i){let s={keyMap:"",funcList:[]};for(let u=0;u<t.length;u++)if(s.keyMap+=encodeURI(t[u]),u+1!==t.length)switch(typeof i[u]){case"function":if(s.keyMap+=` \${${e}:${u}} `,i[u].constructor.name!=="Function")throw new Error("Can not use async function");s.funcList.push(zt(e,i[u])),console.log(s.funcList[u].TEMPLATE_STRING);break;case"object":s.keyMap+=` \${${e}:${u}} `;break;default:s.keyMap+=i[u]}s.keyMap=decodeURI(s.keyMap),console.log(s.keyMap);let r=new RegExp(` \\$\\{${e}:[0-9]\\} `,"g"),n=ht.HTMLParser.parseFromString(s.keyMap.slice(s.keyMap.indexOf("{")+1,s.keyMap.lastIndexOf("}")),"text/html").body;console.dir(n.children),ht.registry[e]=Object.assign(s,{instanceId:e,keys:{}})}function ct(e,...t){let i=window.crypto.randomUUID(),s=window.crypto.randomUUID(),r=Object.assign(new String("<span id="+s+" hidden></span>"),{LIBH_UUID:i});return setTimeout(()=>{let n=document.getElementById(s);if(!n)console.log(`instance created: ${i}`);else{console.log("html appended");let u=n.parentElement;n.remove(),Qt(window.crypto.randomUUID(),e,t)}},0),r}ct.getReservedKey=["global","shared","prop","this","static","method","meta","event","onclick","onchange"];function Kt(e,...t){}function Xt(e,...t){}function Yt(e,...t){}export{Kt as css,ct as html,Yt as sass,Xt as scss};
